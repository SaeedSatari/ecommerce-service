...
class ProductServiceTest {
  ...
  @Test
  @DisplayName(
    "fetchProducts when findAll the products then should returns list of the products"
  )
  void fetchProducts_whenFindAllTheProducts_thenShouldReturnsListOfTheProducts() {
    ...
    assertTrue(
      anyProducts.containsAll(persistedProducts) &&
      persistedProducts.containsAll(anyProducts)
    );
  }

  @Test
  @DisplayName(
    "fetchProducts when can not find products then should throws EntityNotFoundException"
  )
  void fetchProducts_whenCanNotFindProducts_thenShouldThrowsEntityNotFoundException() {
    assertThrows(EntityNotFoundException.class, () -> productService.fetchProducts());
  }

  @Test
  @DisplayName(
    "fetchProduct when find a product with given id then should returns the product"
  )
  ...
  @Test
  @DisplayName(
    "fetchProduct when can not find a product with given id then should throws EntityNotFoundException"
  )
  void fetchProduct_whenCanNotFindAProductWithGivenId_thenShouldThrowsEntityNotFoundException() {
    assertThrows(EntityNotFoundException.class, () -> productService.fetchProduct("1"));
  }

  @Test
  @DisplayName(
    "findByCategoryId when find products by category id then should returns list of the products"
  )
  ...
  @Test
  @DisplayName(
    "findByCategoryId when can not find products by category id then should throws EntityNotFoundException"
  )
  ...
  @Test
  @DisplayName(
    "findByKeyword when find products by keyword then should returns list of the products"
  )
  ...
  @Test
  @DisplayName(
    "findByKeyword when can not find products by keyword then should throws EntityNotFoundException"
  )
