...
class ProductMapperTest {
  ...
  void productCategoryToProductCategoryResponse() {
    ProductCategoryResponse categoryResponse = productMapper.productCategoryToProductCategoryResponse(
      productCategory
    );
  ...
  @Test
  @DisplayName(
    "productToProductResponse when given product is null then product response is null"
  )
  ...
  @Test
  @DisplayName(
    "productCategoryToProductCategoryResponse when given category is null then category response is null"
  )
