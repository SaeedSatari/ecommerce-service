...
CREATE TABLE IF NOT EXISTS `full-stack-ecommerce`.`product` (
    ...
    CONSTRAINT `fk_category` FOREIGN KEY (`category_id`) REFERENCES `full-stack-ecommerce`.`product_category` (`id`)
    )
    ENGINE=InnoDB
    AUTO_INCREMENT = 1;
...
INSERT INTO `full-stack-ecommerce`.PRODUCT_CATEGORY(CATEGORY_NAME) VALUES ('BOOKS');

INSERT INTO `full-stack-ecommerce`.PRODUCT (SKU, NAME, DESCRIPTION, IMAGE_URL, ACTIVE, UNITS_IN_STOCK,
